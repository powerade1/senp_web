    ...
    return (
        <div className='center'>
            ...
            <div className='grid grid-cols-2 gap-4 mt-8'>
                <Link href={'/pages/prod_page/prod/1'}>
                    <Image src={Painting} width={150} alt='painting'/>
                </Link>
                <Link href={'/pages/prod_page/prod/2'}>
                    <Image src={Cup} width={150} alt='cup'/>
                </Link>
                <Link href={'/pages/prod_page/prod/3'}>
                    <Image src={Octopus} width={150} alt='octopus'/>
                </Link>
                <Link href={'/pages/prod_page/prod/4'}>
                    <Image src={Calender} width={150} alt='calender'/>
                </Link>
                <Link href={'/pages/prod_page/prod/5'}>
                    <Image src={Turtle} width={150} alt='turtle'/>
                </Link>
                <Link href={'/pages/prod_page/prod/6'}>
